...
export default function Loading({ label = 'Memuat...' }) {
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center gap-4 bg-paper">
      <svg className="h-8 w-8 animate-spin text-ink" viewBox="0 0 24 24" fill="none">
