...
export default function NotFound() {
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-white px-6 text-center">
      <Link to="/login" className="mb-10 font-display text-2xl font-bold tracking-wider text-black">
        W<span className="text-ink">M.</span>
      </Link>

      <p className="font-display text-8xl font-extrabold text-ash sm:text-9xl">404</p>
      ...
      <Link
        to="/login"
        className="mt-8 bg-ink px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-ink-soft"
      >
        Kembali ke Login
      </Link>
    </div>
